...
def build_report(
    ...
    return {
        "generator": "generate_concept_practice_deck.py",
        "pipeline": "design-contract -> pdf-extraction -> practice-block-ir -> editable-pptx-renderer -> ooxml-style-injection -> validation",
        "generation_mode": deck_info.get("generation_mode", "generic_pdf_text_extraction"),
        ...
        "limitations": [
            "Generic extraction uses PDF text order and heuristic item detection.",
